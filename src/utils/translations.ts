...
export const translations: Record<Language, Translations> = {
  ...
  es: {
    ...
    domainCard: {
      ...
      copy: 'Copiar',
      copied: '¡Copiado!',
      summaryClassificationTitle: 'Resumen y Clasificación Estructural',
      structureType: 'Tipo de Estructura',
      idealSectors: 'Sectores Ideales',
      brandImpression: 'Impresión Inicial de Marca',
      phoneticVisualTitle: 'Métricas Fonéticas y Visuales (Descomposición)',
      lengthLabel: 'Longitud',
      syllablesLabel: 'Sílabas',
      radioTestLabel: 'Prueba de Radio',
      radioTestPass: 'Aprobado con Excelencia',
      synergyMetaphorTitle: 'Sinergia Compuesta y Metáfora Mental',
      metaphorLabel: 'Metáfora Mental',
      visualFlowLabel: 'Fluidez Visual y Tipográfica',
      endUsersTitle: 'Usuarios Finales Objetivo y Caso de Adquisición',
      useCaseLabel: 'Motivo Principal de Adquisición',
      compsLiquidityTitle: 'Liquidez y Ventas Históricas Comparables (Comps)',
      searchVolumeLabel: 'Volumen Mensual de Búsqueda Estimado',
      comparableSalesLabel: 'Ventas Comparables Verificadas',
      dualValuationTitle: 'Valoración Dual Realista',
      resellerWholesale: 'Valor Revendedor / Mayorista',
      endUserRetail: 'Valor Usuario Final / Corporativo',
      valuationTransparency: 'Estándar industrial neutro: separa la reventa mayorista inmediata de la adquisición directa por una empresa.',
    },
    savedDrawer: {
