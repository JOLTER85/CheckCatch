  ...
  return (
    <div
      ...
      className={`group relative rounded-2xl p-5 transition-all duration-200 border flex flex-col justify-between ${
        isSelected
          ? 'bg-white border-blue-500 shadow-lg shadow-blue-500/10 ring-2 ring-blue-500/30'
          : isTopPick
    ...
    >
      ...
      {isSelected && (
        <div className="mb-3 px-3 py-1.5 rounded-xl bg-blue-50 border border-blue-200 flex items-center justify-between text-xs font-bold text-blue-700 shadow-xs animate-fadeIn">
          <div className="flex items-center gap-1.5">
            <Crown className="w-4 h-4 fill-blue-600 text-blue-600" />
            <span>
              {lang === 'ar'
          ...
          <div className="flex items-center gap-1.5 flex-wrap">
            ...
            {isSelected ? (
              <span
                ...
                className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-bold bg-blue-600 text-white shadow-xs"
              >
              ...
              <span
                ...
                className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-bold bg-emerald-50 text-emerald-800 border border-emerald-300 shadow-xs"
              >
              ...
              >
                <Crown
                  className={`w-3.5 h-3.5 ${
                    isSelected ? 'fill-blue-600 text-blue-600' : 'text-slate-400'
                  }`}
                />
